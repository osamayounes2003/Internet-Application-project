...
import 'dart:html' as html; // استيراد مكتبة html لدعم تحميل الملفات في الويب

import '../../SharedPreferences/shared_preferences_service.dart';

class DownloadUserReportController extends GetxController {
  var isLoading = false.obs;
  final SharedPreferencesService _sharedPreferencesService = SharedPreferencesService();

  Future<void> downloadReport(int groupId, int userId) async {
    ...
    var request = http.Request(
        'GET', Uri.parse('http://195.88.87.77:8888/api/v1/reports/user?userId=$userId&folderId=$groupId'));
